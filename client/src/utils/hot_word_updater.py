...
from . import (
    hot_word_replacer_zh,
    hot_word_replacer_en,
    hot_word_replacer_rule,
    hot_word_kwd,
)
...
def update_hot_zh():
    ...
    with open(path_zh, "r", encoding="utf-8") as f:
        num_hot_zh = hot_word_replacer_zh.更新热词词典(f.read())
...
def update_hot_en():
    ...
    with open(path_en, "r", encoding="utf-8") as f:
        num_hot_en = hot_word_replacer_en.更新热词词典(f.read())
...
"""
    ...
    with open(path_rule, "r", encoding="utf-8") as f:
        num_hot_rule = hot_word_replacer_rule.更新热词词典(f.read())
...
def update_hot_kwds():
    ...
    with open(path_kwds, "r", encoding="utf-8") as f:
        num_kwd = hot_word_kwd.do_update_kwd(f.read())
